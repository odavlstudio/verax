/**
 * UX & Output Integration Layer
 * 
 * Integrates all UX and output components into the run command:
 * - Canonical naming
 * - Output contracts
 * - Human summaries
 * - Judgment UX
...
/**
 * Apply canonical naming to run paths
 ...
 */
export function applyCanonicalNaming(projectRoot, outDir, url, srcPath, config, runSequence = 0) {
...
/**
 * Enhance summary.json with production seal
 * @param {Object} summaryData
 * @param {Object} context
 * @returns {Object} Enhanced summary
 */
export function enhanceSummaryWithSeal(summaryData, context) {
  const seal = computeProductionSeal(context);
