...
/**
 * Angular Network Detector class (BaseDetector implementation)
 */
export class AngularNetworkDetector extends BaseDetector {
  constructor() {
    super({
  ...
  detect(filePath, content, projectRoot) {
    return detectAngularNetwork(filePath, content, projectRoot);
  }
}
