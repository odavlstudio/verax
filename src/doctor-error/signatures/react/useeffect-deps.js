...
const useEffectDepsIssue = {
  match: (raw) => /react hook useeffect has a missing dependency|exhaustive-deps/i.test(raw) || /dependency array/i.test(raw),
  diagnose: () => {
    const rankedCauses = [
      {
...
module.exports = { useEffectDepsIssue };
