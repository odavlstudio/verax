...
const cannotUpdateDuringRender = {
  match: (raw) => /cannot update a component .* while rendering a different component/i.test(raw),
  diagnose: () => {
    const rankedCauses = [
      {
...
module.exports = { cannotUpdateDuringRender };
