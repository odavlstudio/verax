...
const steps = [
  {
    number: '1',
    title: 'Scan the page',
    description: 'verax opens the page like a real visitor and discovers meaningful interactions.',
    icon: Eye,
  },
  {
    number: '2',
  ...
  },
  {
    ...
    description: 'If nothing visibly or logically happens, verax flags a silent failure.',
    icon: AlertCircle,
  },
];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-text-secondary max-w-3xl mx-auto">
            verax behaves like a real user — and watches what actually happens.
          </p>
        </motion.div>
        ...
        >
          <div className="glass rounded-xl p-6 border-l-2 border-signal-orange">
            <p className="text-text-secondary text-center text-base">
              verax does not judge intent. It reports observable reality.
            </p>
          </div>
        </motion.div>
